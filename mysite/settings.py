...
SECRET_KEY = 'django-insecure-+mn13bc=6d23or(rjzhb1ke3kk5w#f16$2q217w*u_l8bpl!pb'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'), str(BASE_DIR.joinpath('templates'))],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_REDIRECT_URL = '/extract/search'
